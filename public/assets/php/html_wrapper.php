            ...
            <article class="article-card">
                <?php if (!empty($attraction['image_url'])): ?>
                    <div class="article-featured-image">
                        <img loading="lazy" decoding="async" src="<?= htmlspecialchars($attraction['image_url']) ?>" 
        ...
        <div class="footer-content">
            <div class="footer-section">
                <div class="footer-brand">
                    <a href="../../index.php"><img loading="lazy" decoding="async" src="../images/logo/first-logo.png" alt="RahalLogo" class="footer-logo"></a>
                </div>
